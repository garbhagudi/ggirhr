  ...
  return (
    <div className="zcwf_lblLeft crmWebToEntityForm mx-auto h-auto w-full rounded-lg bg-transparent ">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="pb-4 pt-4 text-center font-[B612] text-xl font-bold  lg:text-2xl">
          GGIRHR Enquiry Form
        </div>
        ...
        <div className="mb-6 mt-6 flex items-center justify-center space-x-4">
          <button
            type="submit"
            className="flex items-center justify-center gap-2 rounded-md bg-brandBlue px-6 py-2 text-base font-bold text-white transition hover:bg-brandBlueDark3"
            disabled={load}
          >
            Submit
            {load && (
          ...
          <button
            ...
            className="rounded-md bg-brandBlue px-6 py-2 text-base font-bold text-white transition hover:bg-brandBlueDark3"
          >
            Reset
          </button>
        </div>
