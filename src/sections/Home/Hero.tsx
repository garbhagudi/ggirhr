...
const Hero = () => {
  return (
    <div className="max-w-7xl mx-auto my-4 md:my-14">
      <div className="relative w-full h-full pb-4">
        <div className="relative px-4 xl:px-0 container mx-auto md:flex items-center gap-8">
          <div className="text-color w-full md:w-1/3 lg:w-1/2 pt-8">
            ...
            <div className="text-base lg:text-base pb-10 sm:pb-0 pt-6">
