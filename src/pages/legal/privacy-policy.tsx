    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mx-auto my-8 px-4 sm:px-0">
          ...
          <div className="text-brandDark my-4 font-qs">
            ...
            <ul className="list-disc text-lg ml-6 space-y-3">
          ...
          <div className="text-brandDark my-4 font-qs">
            ...
            <ul className="list-disc text-lg ml-6 space-y-3">
              ...
              <li>
                We may periodically send promotional emails about special offers
          ...
          <div className=" text-brandDark my-4 font-qs">
            <h3 className="text-2xl font-heading font-semibold">Security:</h3>
